...
const ApprovalDrafts = () => {
  ...
  const selectList = async () => {
    const response = await ApprovalService.getAll(searchKeyword, page - 1, size);
        ...
        <table className="w-[100%] border border-gray-200">
          <thead className="bg-blue-700 text-white">
            <tr>
              ...
              <th className="px-4 py-2 border-b">사번(eno)</th>
              <th className="px-4 py-2 border-b">순번(seq)</th>
