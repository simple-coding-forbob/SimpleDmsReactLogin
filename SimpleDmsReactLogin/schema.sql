...
DROP TABLE TB_APPROVAL_LINE CASCADE CONSTRAINTS;
...
CREATE TABLE TB_DOCUMENT (
                             ...
                             FILE_NAME   VARCHAR2(1000),        -- 첨부파일 이름
                             FILE_PATH   VARCHAR2(4000),        -- 첨부파일 경로 (선택)
...
CREATE TABLE TB_APPROVAL_LINE (
                                  LN_ID        NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                  UUID         VARCHAR2(1000) NOT NULL,
                                  APPROVER     NUMBER NOT NULL, -- 결재자
                                  SEQ          NUMBER NOT NULL, -- 결재 순서
